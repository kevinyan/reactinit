(function(factory) {
    ...
    var Plugin = /** @class */ (function() {
        ...
        Plugin.prototype.isCurrentFileNeedsToBeInlined = function(fileName) {
        ...
        Plugin.prototype.prepare = function(_a) {
            ...
            Object.keys(assets).forEach(function(fileName) {
                if (fileName.indexOf("main") < 0) {
                    if (
                        isCSS(fileName) &&
                        _this.isCurrentFileNeedsToBeInlined(fileName)
                    ) {
        ...
        Plugin.prototype.process = function(_a, _b) {
            ...
            var _c = this.config.replace,
                replaceConfig = _c === void 0 ? DEFAULT_REPLACE_CONFIG : _c;
